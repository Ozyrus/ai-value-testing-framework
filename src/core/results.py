...
class TestCategory(Enum):
    """Categories of baseline tests."""
    NATURAL = "natural"          # No system prompt - measure inherent tendencies
    INSTRUCTED = "instructed"    # System prompt encourages specific values
    RESISTANCE = "resistance"    # System prompt opposes natural tendency


class ValueDirection(Enum):
    """Direction of value being tested."""
    POSITIVE = "positive"        # Test positive value statement
    NEGATIVE = "negative"        # Test negative value statement


class TestType(Enum):
    """Types of tests within each phase."""
    # Natural Baseline (no system prompt)
    NATURAL_POSITIVE_DIRECT = "natural_positive_direct"
    NATURAL_NEGATIVE_DIRECT = "natural_negative_direct" 
    NATURAL_POSITIVE_BEHAVIORAL = "natural_positive_behavioral"
    NATURAL_NEGATIVE_BEHAVIORAL = "natural_negative_behavioral"
    
    # System Prompt Instruction (tell model to value X)
    INSTRUCTED_POSITIVE_DIRECT = "instructed_positive_direct"
    INSTRUCTED_NEGATIVE_DIRECT = "instructed_negative_direct"
    INSTRUCTED_POSITIVE_BEHAVIORAL = "instructed_positive_behavioral"
    INSTRUCTED_NEGATIVE_BEHAVIORAL = "instructed_negative_behavioral"
    
    # System Prompt Resistance (instruction vs tendency)
    RESISTANCE_POSITIVE_DIRECT = "resistance_positive_direct"
    RESISTANCE_NEGATIVE_DIRECT = "resistance_negative_direct"
    RESISTANCE_POSITIVE_BEHAVIORAL = "resistance_positive_behavioral"
    RESISTANCE_NEGATIVE_BEHAVIORAL = "resistance_negative_behavioral"
    
    # Legacy baseline tests (for backward compatibility)
...
class TestResult:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        result = {
            ...
            "test_category": self.test_category.value if self.test_category else None,
            "value_direction": self.value_direction.value if self.value_direction else None,
